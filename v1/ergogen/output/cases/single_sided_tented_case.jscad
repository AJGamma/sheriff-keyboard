...
.union(
    CAG.circle({"center":[189.35,-77.825],"radius":5.5})
                ...
                function single_sided_tented_case_case_fn() {
                    

                // creating part 0 of case single_sided_tented_case
                let single_sided_tented_case__part_0 = _single_sided_tented_case_base_extrude_4_outline_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_0_bounds = single_sided_tented_case__part_0.getBounds();
                let single_sided_tented_case__part_0_x = single_sided_tented_case__part_0_bounds[0].x + (single_sided_tented_case__part_0_bounds[1].x - single_sided_tented_case__part_0_bounds[0].x) / 2
                let single_sided_tented_case__part_0_y = single_sided_tented_case__part_0_bounds[0].y + (single_sided_tented_case__part_0_bounds[1].y - single_sided_tented_case__part_0_bounds[0].y) / 2
                single_sided_tented_case__part_0 = translate([-single_sided_tented_case__part_0_x, -single_sided_tented_case__part_0_y, 0], single_sided_tented_case__part_0);
                single_sided_tented_case__part_0 = rotate([0,0,0], single_sided_tented_case__part_0);
                single_sided_tented_case__part_0 = translate([single_sided_tented_case__part_0_x, single_sided_tented_case__part_0_y, 0], single_sided_tented_case__part_0);

                single_sided_tented_case__part_0 = translate([0,0,0], single_sided_tented_case__part_0);
                let result = single_sided_tented_case__part_0;
                
            

                // creating part 1 of case single_sided_tented_case
                let single_sided_tented_case__part_1 = _case_base_board_extrude_100_outline_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_1_bounds = single_sided_tented_case__part_1.getBounds();
                let single_sided_tented_case__part_1_x = single_sided_tented_case__part_1_bounds[0].x + (single_sided_tented_case__part_1_bounds[1].x - single_sided_tented_case__part_1_bounds[0].x) / 2
                let single_sided_tented_case__part_1_y = single_sided_tented_case__part_1_bounds[0].y + (single_sided_tented_case__part_1_bounds[1].y - single_sided_tented_case__part_1_bounds[0].y) / 2
                single_sided_tented_case__part_1 = translate([-single_sided_tented_case__part_1_x, -single_sided_tented_case__part_1_y, 0], single_sided_tented_case__part_1);
                single_sided_tented_case__part_1 = rotate([0,0,0], single_sided_tented_case__part_1);
                single_sided_tented_case__part_1 = translate([single_sided_tented_case__part_1_x, single_sided_tented_case__part_1_y, 0], single_sided_tented_case__part_1);

                single_sided_tented_case__part_1 = translate([0,0,3], single_sided_tented_case__part_1);
                result = result.subtract(single_sided_tented_case__part_1);
                
            

                // creating part 2 of case single_sided_tented_case
                let single_sided_tented_case__part_2 = _case_wall_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_2_bounds = single_sided_tented_case__part_2.getBounds();
                let single_sided_tented_case__part_2_x = single_sided_tented_case__part_2_bounds[0].x + (single_sided_tented_case__part_2_bounds[1].x - single_sided_tented_case__part_2_bounds[0].x) / 2
                let single_sided_tented_case__part_2_y = single_sided_tented_case__part_2_bounds[0].y + (single_sided_tented_case__part_2_bounds[1].y - single_sided_tented_case__part_2_bounds[0].y) / 2
                single_sided_tented_case__part_2 = translate([-single_sided_tented_case__part_2_x, -single_sided_tented_case__part_2_y, 0], single_sided_tented_case__part_2);
                single_sided_tented_case__part_2 = rotate([0,0,0], single_sided_tented_case__part_2);
                single_sided_tented_case__part_2 = translate([single_sided_tented_case__part_2_x, single_sided_tented_case__part_2_y, 0], single_sided_tented_case__part_2);

                single_sided_tented_case__part_2 = translate([0,0,0], single_sided_tented_case__part_2);
                result = result.union(single_sided_tented_case__part_2);
                
            

                // creating part 3 of case single_sided_tented_case
                let single_sided_tented_case__part_3 = _usb_wall_cutout_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_3_bounds = single_sided_tented_case__part_3.getBounds();
                let single_sided_tented_case__part_3_x = single_sided_tented_case__part_3_bounds[0].x + (single_sided_tented_case__part_3_bounds[1].x - single_sided_tented_case__part_3_bounds[0].x) / 2
                let single_sided_tented_case__part_3_y = single_sided_tented_case__part_3_bounds[0].y + (single_sided_tented_case__part_3_bounds[1].y - single_sided_tented_case__part_3_bounds[0].y) / 2
                single_sided_tented_case__part_3 = translate([-single_sided_tented_case__part_3_x, -single_sided_tented_case__part_3_y, 0], single_sided_tented_case__part_3);
                single_sided_tented_case__part_3 = rotate([0,0,0], single_sided_tented_case__part_3);
                single_sided_tented_case__part_3 = translate([single_sided_tented_case__part_3_x, single_sided_tented_case__part_3_y, 0], single_sided_tented_case__part_3);

                single_sided_tented_case__part_3 = translate([0,0,0], single_sided_tented_case__part_3);
                result = result.subtract(single_sided_tented_case__part_3);
                
            

                // creating part 4 of case single_sided_tented_case
                let single_sided_tented_case__part_4 = _trrs_cutout_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_4_bounds = single_sided_tented_case__part_4.getBounds();
                let single_sided_tented_case__part_4_x = single_sided_tented_case__part_4_bounds[0].x + (single_sided_tented_case__part_4_bounds[1].x - single_sided_tented_case__part_4_bounds[0].x) / 2
                let single_sided_tented_case__part_4_y = single_sided_tented_case__part_4_bounds[0].y + (single_sided_tented_case__part_4_bounds[1].y - single_sided_tented_case__part_4_bounds[0].y) / 2
                single_sided_tented_case__part_4 = translate([-single_sided_tented_case__part_4_x, -single_sided_tented_case__part_4_y, 0], single_sided_tented_case__part_4);
                single_sided_tented_case__part_4 = rotate([0,0,0], single_sided_tented_case__part_4);
                single_sided_tented_case__part_4 = translate([single_sided_tented_case__part_4_x, single_sided_tented_case__part_4_y, 0], single_sided_tented_case__part_4);

                single_sided_tented_case__part_4 = translate([0,0,0], single_sided_tented_case__part_4);
                result = result.subtract(single_sided_tented_case__part_4);
                
            

                // creating part 5 of case single_sided_tented_case
                let single_sided_tented_case__part_5 = _case_standoff_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_5_bounds = single_sided_tented_case__part_5.getBounds();
                let single_sided_tented_case__part_5_x = single_sided_tented_case__part_5_bounds[0].x + (single_sided_tented_case__part_5_bounds[1].x - single_sided_tented_case__part_5_bounds[0].x) / 2
                let single_sided_tented_case__part_5_y = single_sided_tented_case__part_5_bounds[0].y + (single_sided_tented_case__part_5_bounds[1].y - single_sided_tented_case__part_5_bounds[0].y) / 2
                single_sided_tented_case__part_5 = translate([-single_sided_tented_case__part_5_x, -single_sided_tented_case__part_5_y, 0], single_sided_tented_case__part_5);
                single_sided_tented_case__part_5 = rotate([0,0,0], single_sided_tented_case__part_5);
                single_sided_tented_case__part_5 = translate([single_sided_tented_case__part_5_x, single_sided_tented_case__part_5_y, 0], single_sided_tented_case__part_5);

                single_sided_tented_case__part_5 = translate([0,0,0], single_sided_tented_case__part_5);
                result = result.union(single_sided_tented_case__part_5);
                
            

                // creating part 6 of case single_sided_tented_case
                let single_sided_tented_case__part_6 = _case_screw_inserts_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_6_bounds = single_sided_tented_case__part_6.getBounds();
                let single_sided_tented_case__part_6_x = single_sided_tented_case__part_6_bounds[0].x + (single_sided_tented_case__part_6_bounds[1].x - single_sided_tented_case__part_6_bounds[0].x) / 2
                let single_sided_tented_case__part_6_y = single_sided_tented_case__part_6_bounds[0].y + (single_sided_tented_case__part_6_bounds[1].y - single_sided_tented_case__part_6_bounds[0].y) / 2
                single_sided_tented_case__part_6 = translate([-single_sided_tented_case__part_6_x, -single_sided_tented_case__part_6_y, 0], single_sided_tented_case__part_6);
                single_sided_tented_case__part_6 = rotate([0,0,0], single_sided_tented_case__part_6);
                single_sided_tented_case__part_6 = translate([single_sided_tented_case__part_6_x, single_sided_tented_case__part_6_y, 0], single_sided_tented_case__part_6);

                single_sided_tented_case__part_6 = translate([0,0,0], single_sided_tented_case__part_6);
                result = result.subtract(single_sided_tented_case__part_6);
                
            

                // creating part 7 of case single_sided_tented_case
                let single_sided_tented_case__part_7 = _case_footpad_left_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_7_bounds = single_sided_tented_case__part_7.getBounds();
                let single_sided_tented_case__part_7_x = single_sided_tented_case__part_7_bounds[0].x + (single_sided_tented_case__part_7_bounds[1].x - single_sided_tented_case__part_7_bounds[0].x) / 2
                let single_sided_tented_case__part_7_y = single_sided_tented_case__part_7_bounds[0].y + (single_sided_tented_case__part_7_bounds[1].y - single_sided_tented_case__part_7_bounds[0].y) / 2
                single_sided_tented_case__part_7 = translate([-single_sided_tented_case__part_7_x, -single_sided_tented_case__part_7_y, 0], single_sided_tented_case__part_7);
                single_sided_tented_case__part_7 = rotate([0,0,0], single_sided_tented_case__part_7);
                single_sided_tented_case__part_7 = translate([single_sided_tented_case__part_7_x, single_sided_tented_case__part_7_y, 0], single_sided_tented_case__part_7);

                single_sided_tented_case__part_7 = translate([0,0,0], single_sided_tented_case__part_7);
                result = result.subtract(single_sided_tented_case__part_7);
                
            

                // creating part 8 of case single_sided_tented_case
                let single_sided_tented_case__part_8 = _case_footpad_right_case_fn();

                // make sure that rotations are relative
                let single_sided_tented_case__part_8_bounds = single_sided_tented_case__part_8.getBounds();
                let single_sided_tented_case__part_8_x = single_sided_tented_case__part_8_bounds[0].x + (single_sided_tented_case__part_8_bounds[1].x - single_sided_tented_case__part_8_bounds[0].x) / 2
                let single_sided_tented_case__part_8_y = single_sided_tented_case__part_8_bounds[0].y + (single_sided_tented_case__part_8_bounds[1].y - single_sided_tented_case__part_8_bounds[0].y) / 2
                single_sided_tented_case__part_8 = translate([-single_sided_tented_case__part_8_x, -single_sided_tented_case__part_8_y, 0], single_sided_tented_case__part_8);
                single_sided_tented_case__part_8 = rotate([0,0,0], single_sided_tented_case__part_8);
                single_sided_tented_case__part_8 = translate([single_sided_tented_case__part_8_x, single_sided_tented_case__part_8_y, 0], single_sided_tented_case__part_8);

                single_sided_tented_case__part_8 = translate([0,0,0], single_sided_tented_case__part_8);
                result = result.subtract(single_sided_tented_case__part_8);
            ...
            function main() {
                return single_sided_tented_case_case_fn();
            }
