...
.union(
    CAG.circle({"center":[189.35,-77.825],"radius":5.5})
                ...
                function tented_case_case_fn() {
                    

                // creating part 0 of case tented_case
                let tented_case__part_0 = _tented_case_base_extrude_4_outline_fn();

                // make sure that rotations are relative
                let tented_case__part_0_bounds = tented_case__part_0.getBounds();
                let tented_case__part_0_x = tented_case__part_0_bounds[0].x + (tented_case__part_0_bounds[1].x - tented_case__part_0_bounds[0].x) / 2
                let tented_case__part_0_y = tented_case__part_0_bounds[0].y + (tented_case__part_0_bounds[1].y - tented_case__part_0_bounds[0].y) / 2
                tented_case__part_0 = translate([-tented_case__part_0_x, -tented_case__part_0_y, 0], tented_case__part_0);
                tented_case__part_0 = rotate([0,0,0], tented_case__part_0);
                tented_case__part_0 = translate([tented_case__part_0_x, tented_case__part_0_y, 0], tented_case__part_0);

                tented_case__part_0 = translate([0,0,0], tented_case__part_0);
                let result = tented_case__part_0;
                
            

                // creating part 1 of case tented_case
                let tented_case__part_1 = _case_base_board_extrude_100_outline_fn();

                // make sure that rotations are relative
                let tented_case__part_1_bounds = tented_case__part_1.getBounds();
                let tented_case__part_1_x = tented_case__part_1_bounds[0].x + (tented_case__part_1_bounds[1].x - tented_case__part_1_bounds[0].x) / 2
                let tented_case__part_1_y = tented_case__part_1_bounds[0].y + (tented_case__part_1_bounds[1].y - tented_case__part_1_bounds[0].y) / 2
                tented_case__part_1 = translate([-tented_case__part_1_x, -tented_case__part_1_y, 0], tented_case__part_1);
                tented_case__part_1 = rotate([0,0,0], tented_case__part_1);
                tented_case__part_1 = translate([tented_case__part_1_x, tented_case__part_1_y, 0], tented_case__part_1);

                tented_case__part_1 = translate([0,0,3], tented_case__part_1);
                result = result.subtract(tented_case__part_1);
                
            

                // creating part 2 of case tented_case
                let tented_case__part_2 = _case_wall_case_fn();

                // make sure that rotations are relative
                let tented_case__part_2_bounds = tented_case__part_2.getBounds();
                let tented_case__part_2_x = tented_case__part_2_bounds[0].x + (tented_case__part_2_bounds[1].x - tented_case__part_2_bounds[0].x) / 2
                let tented_case__part_2_y = tented_case__part_2_bounds[0].y + (tented_case__part_2_bounds[1].y - tented_case__part_2_bounds[0].y) / 2
                tented_case__part_2 = translate([-tented_case__part_2_x, -tented_case__part_2_y, 0], tented_case__part_2);
                tented_case__part_2 = rotate([0,0,0], tented_case__part_2);
                tented_case__part_2 = translate([tented_case__part_2_x, tented_case__part_2_y, 0], tented_case__part_2);

                tented_case__part_2 = translate([0,0,0], tented_case__part_2);
                result = result.union(tented_case__part_2);
                
            

                // creating part 3 of case tented_case
                let tented_case__part_3 = _usb_wall_cutout_case_fn();

                // make sure that rotations are relative
                let tented_case__part_3_bounds = tented_case__part_3.getBounds();
                let tented_case__part_3_x = tented_case__part_3_bounds[0].x + (tented_case__part_3_bounds[1].x - tented_case__part_3_bounds[0].x) / 2
                let tented_case__part_3_y = tented_case__part_3_bounds[0].y + (tented_case__part_3_bounds[1].y - tented_case__part_3_bounds[0].y) / 2
                tented_case__part_3 = translate([-tented_case__part_3_x, -tented_case__part_3_y, 0], tented_case__part_3);
                tented_case__part_3 = rotate([0,0,0], tented_case__part_3);
                tented_case__part_3 = translate([tented_case__part_3_x, tented_case__part_3_y, 0], tented_case__part_3);

                tented_case__part_3 = translate([0,0,0], tented_case__part_3);
                result = result.subtract(tented_case__part_3);
                
            

                // creating part 4 of case tented_case
                let tented_case__part_4 = _trrs_cutout_case_fn();

                // make sure that rotations are relative
                let tented_case__part_4_bounds = tented_case__part_4.getBounds();
                let tented_case__part_4_x = tented_case__part_4_bounds[0].x + (tented_case__part_4_bounds[1].x - tented_case__part_4_bounds[0].x) / 2
                let tented_case__part_4_y = tented_case__part_4_bounds[0].y + (tented_case__part_4_bounds[1].y - tented_case__part_4_bounds[0].y) / 2
                tented_case__part_4 = translate([-tented_case__part_4_x, -tented_case__part_4_y, 0], tented_case__part_4);
                tented_case__part_4 = rotate([0,0,0], tented_case__part_4);
                tented_case__part_4 = translate([tented_case__part_4_x, tented_case__part_4_y, 0], tented_case__part_4);

                tented_case__part_4 = translate([0,0,0], tented_case__part_4);
                result = result.subtract(tented_case__part_4);
                
            

                // creating part 5 of case tented_case
                let tented_case__part_5 = _case_standoff_case_fn();

                // make sure that rotations are relative
                let tented_case__part_5_bounds = tented_case__part_5.getBounds();
                let tented_case__part_5_x = tented_case__part_5_bounds[0].x + (tented_case__part_5_bounds[1].x - tented_case__part_5_bounds[0].x) / 2
                let tented_case__part_5_y = tented_case__part_5_bounds[0].y + (tented_case__part_5_bounds[1].y - tented_case__part_5_bounds[0].y) / 2
                tented_case__part_5 = translate([-tented_case__part_5_x, -tented_case__part_5_y, 0], tented_case__part_5);
                tented_case__part_5 = rotate([0,0,0], tented_case__part_5);
                tented_case__part_5 = translate([tented_case__part_5_x, tented_case__part_5_y, 0], tented_case__part_5);

                tented_case__part_5 = translate([0,0,0], tented_case__part_5);
                result = result.union(tented_case__part_5);
                
            

                // creating part 6 of case tented_case
                let tented_case__part_6 = _case_screw_inserts_case_fn();

                // make sure that rotations are relative
                let tented_case__part_6_bounds = tented_case__part_6.getBounds();
                let tented_case__part_6_x = tented_case__part_6_bounds[0].x + (tented_case__part_6_bounds[1].x - tented_case__part_6_bounds[0].x) / 2
                let tented_case__part_6_y = tented_case__part_6_bounds[0].y + (tented_case__part_6_bounds[1].y - tented_case__part_6_bounds[0].y) / 2
                tented_case__part_6 = translate([-tented_case__part_6_x, -tented_case__part_6_y, 0], tented_case__part_6);
                tented_case__part_6 = rotate([0,0,0], tented_case__part_6);
                tented_case__part_6 = translate([tented_case__part_6_x, tented_case__part_6_y, 0], tented_case__part_6);

                tented_case__part_6 = translate([0,0,0], tented_case__part_6);
                result = result.subtract(tented_case__part_6);
                ...
                function tented_case_with_footpads_case_fn() {
                    

                // creating part 0 of case tented_case_with_footpads
                let tented_case_with_footpads__part_0 = tented_case_case_fn();

                // make sure that rotations are relative
                let tented_case_with_footpads__part_0_bounds = tented_case_with_footpads__part_0.getBounds();
                let tented_case_with_footpads__part_0_x = tented_case_with_footpads__part_0_bounds[0].x + (tented_case_with_footpads__part_0_bounds[1].x - tented_case_with_footpads__part_0_bounds[0].x) / 2
                let tented_case_with_footpads__part_0_y = tented_case_with_footpads__part_0_bounds[0].y + (tented_case_with_footpads__part_0_bounds[1].y - tented_case_with_footpads__part_0_bounds[0].y) / 2
                tented_case_with_footpads__part_0 = translate([-tented_case_with_footpads__part_0_x, -tented_case_with_footpads__part_0_y, 0], tented_case_with_footpads__part_0);
                tented_case_with_footpads__part_0 = rotate([0,0,0], tented_case_with_footpads__part_0);
                tented_case_with_footpads__part_0 = translate([tented_case_with_footpads__part_0_x, tented_case_with_footpads__part_0_y, 0], tented_case_with_footpads__part_0);

                tented_case_with_footpads__part_0 = translate([0,0,0], tented_case_with_footpads__part_0);
                let result = tented_case_with_footpads__part_0;
                
            

                // creating part 1 of case tented_case_with_footpads
                let tented_case_with_footpads__part_1 = _case_footpad_left_case_fn();

                // make sure that rotations are relative
                let tented_case_with_footpads__part_1_bounds = tented_case_with_footpads__part_1.getBounds();
                let tented_case_with_footpads__part_1_x = tented_case_with_footpads__part_1_bounds[0].x + (tented_case_with_footpads__part_1_bounds[1].x - tented_case_with_footpads__part_1_bounds[0].x) / 2
                let tented_case_with_footpads__part_1_y = tented_case_with_footpads__part_1_bounds[0].y + (tented_case_with_footpads__part_1_bounds[1].y - tented_case_with_footpads__part_1_bounds[0].y) / 2
                tented_case_with_footpads__part_1 = translate([-tented_case_with_footpads__part_1_x, -tented_case_with_footpads__part_1_y, 0], tented_case_with_footpads__part_1);
                tented_case_with_footpads__part_1 = rotate([0,0,0], tented_case_with_footpads__part_1);
                tented_case_with_footpads__part_1 = translate([tented_case_with_footpads__part_1_x, tented_case_with_footpads__part_1_y, 0], tented_case_with_footpads__part_1);

                tented_case_with_footpads__part_1 = translate([0,0,0], tented_case_with_footpads__part_1);
                result = result.subtract(tented_case_with_footpads__part_1);
                
            

                // creating part 2 of case tented_case_with_footpads
                let tented_case_with_footpads__part_2 = _case_footpad_right_case_fn();

                // make sure that rotations are relative
                let tented_case_with_footpads__part_2_bounds = tented_case_with_footpads__part_2.getBounds();
                let tented_case_with_footpads__part_2_x = tented_case_with_footpads__part_2_bounds[0].x + (tented_case_with_footpads__part_2_bounds[1].x - tented_case_with_footpads__part_2_bounds[0].x) / 2
                let tented_case_with_footpads__part_2_y = tented_case_with_footpads__part_2_bounds[0].y + (tented_case_with_footpads__part_2_bounds[1].y - tented_case_with_footpads__part_2_bounds[0].y) / 2
                tented_case_with_footpads__part_2 = translate([-tented_case_with_footpads__part_2_x, -tented_case_with_footpads__part_2_y, 0], tented_case_with_footpads__part_2);
                tented_case_with_footpads__part_2 = rotate([0,0,0], tented_case_with_footpads__part_2);
                tented_case_with_footpads__part_2 = translate([tented_case_with_footpads__part_2_x, tented_case_with_footpads__part_2_y, 0], tented_case_with_footpads__part_2);

                tented_case_with_footpads__part_2 = translate([0,0,0], tented_case_with_footpads__part_2);
                result = result.subtract(tented_case_with_footpads__part_2);
            ...
            function main() {
                return tented_case_with_footpads_case_fn();
            }
