...
.union(
    CAG.circle({"center":[189.35,-77.825],"radius":5.5})
                ...
                function lifted_tented_case_with_footpads_case_fn() {
                    

                // creating part 0 of case lifted_tented_case_with_footpads
                let lifted_tented_case_with_footpads__part_0 = lifted_tented_case_case_fn();

                // make sure that rotations are relative
                let lifted_tented_case_with_footpads__part_0_bounds = lifted_tented_case_with_footpads__part_0.getBounds();
                let lifted_tented_case_with_footpads__part_0_x = lifted_tented_case_with_footpads__part_0_bounds[0].x + (lifted_tented_case_with_footpads__part_0_bounds[1].x - lifted_tented_case_with_footpads__part_0_bounds[0].x) / 2
                let lifted_tented_case_with_footpads__part_0_y = lifted_tented_case_with_footpads__part_0_bounds[0].y + (lifted_tented_case_with_footpads__part_0_bounds[1].y - lifted_tented_case_with_footpads__part_0_bounds[0].y) / 2
                lifted_tented_case_with_footpads__part_0 = translate([-lifted_tented_case_with_footpads__part_0_x, -lifted_tented_case_with_footpads__part_0_y, 0], lifted_tented_case_with_footpads__part_0);
                lifted_tented_case_with_footpads__part_0 = rotate([0,0,0], lifted_tented_case_with_footpads__part_0);
                lifted_tented_case_with_footpads__part_0 = translate([lifted_tented_case_with_footpads__part_0_x, lifted_tented_case_with_footpads__part_0_y, 0], lifted_tented_case_with_footpads__part_0);

                lifted_tented_case_with_footpads__part_0 = translate([0,0,0], lifted_tented_case_with_footpads__part_0);
                let result = lifted_tented_case_with_footpads__part_0;
                
            

                // creating part 1 of case lifted_tented_case_with_footpads
                let lifted_tented_case_with_footpads__part_1 = _case_footpad_left_case_fn();

                // make sure that rotations are relative
                let lifted_tented_case_with_footpads__part_1_bounds = lifted_tented_case_with_footpads__part_1.getBounds();
                let lifted_tented_case_with_footpads__part_1_x = lifted_tented_case_with_footpads__part_1_bounds[0].x + (lifted_tented_case_with_footpads__part_1_bounds[1].x - lifted_tented_case_with_footpads__part_1_bounds[0].x) / 2
                let lifted_tented_case_with_footpads__part_1_y = lifted_tented_case_with_footpads__part_1_bounds[0].y + (lifted_tented_case_with_footpads__part_1_bounds[1].y - lifted_tented_case_with_footpads__part_1_bounds[0].y) / 2
                lifted_tented_case_with_footpads__part_1 = translate([-lifted_tented_case_with_footpads__part_1_x, -lifted_tented_case_with_footpads__part_1_y, 0], lifted_tented_case_with_footpads__part_1);
                lifted_tented_case_with_footpads__part_1 = rotate([0,0,0], lifted_tented_case_with_footpads__part_1);
                lifted_tented_case_with_footpads__part_1 = translate([lifted_tented_case_with_footpads__part_1_x, lifted_tented_case_with_footpads__part_1_y, 0], lifted_tented_case_with_footpads__part_1);

                lifted_tented_case_with_footpads__part_1 = translate([0,0,0], lifted_tented_case_with_footpads__part_1);
                result = result.subtract(lifted_tented_case_with_footpads__part_1);
                
            

                // creating part 2 of case lifted_tented_case_with_footpads
                let lifted_tented_case_with_footpads__part_2 = _case_footpad_right_case_fn();

                // make sure that rotations are relative
                let lifted_tented_case_with_footpads__part_2_bounds = lifted_tented_case_with_footpads__part_2.getBounds();
                let lifted_tented_case_with_footpads__part_2_x = lifted_tented_case_with_footpads__part_2_bounds[0].x + (lifted_tented_case_with_footpads__part_2_bounds[1].x - lifted_tented_case_with_footpads__part_2_bounds[0].x) / 2
                let lifted_tented_case_with_footpads__part_2_y = lifted_tented_case_with_footpads__part_2_bounds[0].y + (lifted_tented_case_with_footpads__part_2_bounds[1].y - lifted_tented_case_with_footpads__part_2_bounds[0].y) / 2
                lifted_tented_case_with_footpads__part_2 = translate([-lifted_tented_case_with_footpads__part_2_x, -lifted_tented_case_with_footpads__part_2_y, 0], lifted_tented_case_with_footpads__part_2);
                lifted_tented_case_with_footpads__part_2 = rotate([0,0,0], lifted_tented_case_with_footpads__part_2);
                lifted_tented_case_with_footpads__part_2 = translate([lifted_tented_case_with_footpads__part_2_x, lifted_tented_case_with_footpads__part_2_y, 0], lifted_tented_case_with_footpads__part_2);

                lifted_tented_case_with_footpads__part_2 = translate([0,0,0], lifted_tented_case_with_footpads__part_2);
                result = result.subtract(lifted_tented_case_with_footpads__part_2);
            ...
            function main() {
                return lifted_tented_case_with_footpads_case_fn();
            }
